...
// MD5 algo from https://github.com/Zunawe/md5-c 
#include <stdio.h>
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
...
bool check_zeros(uint8_t *arr)
{
    if(((arr[0]&0xFF) == 0) && ((arr[1]&0xFF) == 0) && ((arr[2]&0xF0) == 0) )
    {
        return true;
    }
    return false;
}
bool check_six_zeros(uint8_t *arr)
{
    if(((arr[0]&0xFF) == 0) && ((arr[1]&0xFF) == 0) && ((arr[2]&0xFF) == 0) )
    {
        return true;
    }
    return false;
